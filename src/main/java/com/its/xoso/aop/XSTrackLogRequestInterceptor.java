...
@Log4j2
public class XSTrackLogRequestInterceptor implements HandlerInterceptor {

    private static final String START_ATTR = XSTrackLogRequestInterceptor.class.getName() + ".startTime";
    private static final String HANDLING_ATTR = XSTrackLogRequestInterceptor.class.getName() + ".handlingTime";
    private static final long DEFAULT_WARN_NANOS;
    private long warnHandlingNanos;

    public XSTrackLogRequestInterceptor() {

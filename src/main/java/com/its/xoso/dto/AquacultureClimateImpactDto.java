...
@Data
public class AquacultureClimateImpactDto {
    private String weatherType;                     // Loại hình thời tiết
    private String field;                           // Lĩnh vực
    private String affectedGroup;                   // Nhóm chịu ảnh hưởng
    private Integer reportYear;                     // Năm báo cáo
    private String province;                        // Tỉnh

    private Double impactFoodChainPercent;          // % mức độ tác động do thay đổi chuỗi thức ăn tự nhiên

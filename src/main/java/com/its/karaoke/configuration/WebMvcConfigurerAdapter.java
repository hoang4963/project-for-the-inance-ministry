package com.its.karaoke.configuration;


import com.its.karaoke.aop.KaraTrackLogRequestInterceptor;
import com.its.karaoke.interceptor.KaraInterceptor;
...
public class WebMvcConfigurerAdapter implements WebMvcConfigurer {
    ...
    @Autowired
    private KaraInterceptor interceptor;

    @Bean
    public KaraTrackLogRequestInterceptor buildTraceLog() {
        return new KaraTrackLogRequestInterceptor();
    }
